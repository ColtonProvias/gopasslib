...
func (x PasswordPBKDF2_HashAlgorithm) Enum() *PasswordPBKDF2_HashAlgorithm {
	p := new(PasswordPBKDF2_HashAlgorithm)
	*p = x
	return p
}

func (x PasswordPBKDF2_HashAlgorithm) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PasswordPBKDF2_HashAlgorithm) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_gopasslib_proto_enumTypes[2].Descriptor()
}

func (PasswordPBKDF2_HashAlgorithm) Type() protoreflect.EnumType {
	return &file_proto_gopasslib_proto_enumTypes[2]
}

func (x PasswordPBKDF2_HashAlgorithm) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
type PasswordPBKDF2 struct {
	...
	HashAlgorithm PasswordPBKDF2_HashAlgorithm `protobuf:"varint,1,opt,name=hash_algorithm,json=hashAlgorithm,proto3,enum=com.github.coltonprovias.gopasslib.proto.PasswordPBKDF2_HashAlgorithm" json:"hash_algorithm,omitempty"`
	// The hashed password.
	Hash []byte `protobuf:"bytes,2,opt,name=hash,proto3" json:"hash,omitempty"`
	// The salt used in hashing.
	Salt []byte `protobuf:"bytes,3,opt,name=salt,proto3" json:"salt,omitempty"`
...
func (x *PasswordPBKDF2) GetHashAlgorithm() PasswordPBKDF2_HashAlgorithm {
	...
	return PasswordPBKDF2_PBKDF2_HASH_UNDEFINED
}
...
var file_proto_gopasslib_proto_rawDesc = []byte{
	...
	,
	...
	,
